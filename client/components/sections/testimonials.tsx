...
export function TestimonialsSection() {
  const testimonials = [
    {
      quote: "AstroTalk's guidance has been invaluable in my business decisions. The astrologers here are truly gifted!",
      name: "Priya Sharma",
    ...
    {
      quote: "The Vastu consultation helped transform my home into a peaceful sanctuary. Thank you, AstroTalk!",
      name: "Anita Desai",
      designation: "Teacher",
